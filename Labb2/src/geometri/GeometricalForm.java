 ...
 * rectangle surrounding the form as narrow as possible defined by its width and
 * height, the position of the upper left corner of the surrounding rectangle,
 ...
 * is 0 and its perimeter is the length of the line.
 * <p>
 * The forms may be moved, but may not be modyfied in any other way. Only
...
public interface GeometricalForm extends Comparable<GeometricalForm> {
	...
	/**
	 * The method <tt>compareTo</tt> compares the area and perimeter of the
	 * forms to decide if the given geometrical form is less or greater than
	 * this object. If they have the same area, the perimeter decides.
	 * 
	 * @param f
	 *            The geometrical form to compare with.
	 * @return An integer smaller than 0 if this form is smaller than the form
	 *         given as argument, 0 if the sizes are equal, and a positive
	 *         integer otherwise.
	 */
	public int compareTo(GeometricalForm f);

	/**
	 * Fill the area of the form at the position of the form with the color of
	 * the form.
	 *
	 * @param g
	 *            A graphic pen to draw with.
	 */
	...
	/**
	 * Move the form the given distances. Check if the new coordinates are legal
	 * and if they are, set the position to the new coordinates. Otherwise an
	 * <tt>IllegalPositionException</tt> is thrown. Origo is (0,0) and only
	 * positive coordinates are legal.
	 *
	 * @param dx
	 *            move the form dx points to the right.
	 * @param dy
	 *            move the form dy points down.
	 * @throws IllegalPositionException
	 *             if any coordinate becomes negative.
	 */
	 ...
	 * Origo is (0,0) and only positive coordinates are legal. If they are
	 * legal, update the position with the new coordinates. Otherwise an
	 * <tt>IllegalPositionException</tt> is thrown.
	 *
	 * @param x
	 *            Distance right from origo.
	 * @param y
